...
Network IOC Capture is optional and gated. BrowserPilot v0.3.2 generates local IOC/evidence packages only after a user-reviewed suspicious or likely threat flow.
